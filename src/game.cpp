...
Game::Game(vector<Candy> candies, vector<Character> character){
    _candies = candies;
...
void Game::loadCandies(string filename)
{
...
{
    cout << "start of load characters" << endl;
...
Character Game::pickCharacter()
{
    ...
    do{
        ...
        for(int i = 0; i< _characters.size(); i++)
        {
            ...
            for(int j = 0; j<currentCharName.length(); j++)
            {
